  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          type="button"
          className="flex items-center gap-2 rounded-xl border border-border bg-muted/50 py-1 pl-1 pr-2 transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
        ...
        >
          <Avatar className="size-8">
            <AvatarFallback
              className={
                platform
                  ? "bg-gold text-xs font-semibold text-gold-foreground"
      ...
      <DropdownMenuContent align="end" className="w-64 border-border bg-sidebar">
